...
// Use the AppConfig.cs configuration file to load configuration settings.
...
builder.Services.AddSingleton<CosmosClient>((_) =>
{
 ...
 // create an IKernelBuilder and then add Azure OpenAI chat completion, using the deployment name, endpoint, and API key from your configuration.
...
app.MapGet("/", async () => 
{
    return "Welcome to the Contoso Suites Web API o yeah!";
})
    .WithName("Index")
    .WithOpenApi();
