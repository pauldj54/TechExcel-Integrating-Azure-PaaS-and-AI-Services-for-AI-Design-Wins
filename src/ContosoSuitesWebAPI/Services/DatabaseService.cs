...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId,[Description("Date to start searching for bookings")] DateTime dt)
    {
    ...
    /// <summary>
    /// Get bookings without any hotel room assigned.
    /// </summary>
    [KernelFunction]
    [Description("Get all bookings without hotel rooms.")]
    ...
    /// <summary>
    /// Get bookings with multiple rooms.
    /// </summary>
    [KernelFunction]
